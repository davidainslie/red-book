...
import scala.{Option => _} // Hide std library `Option` since we are writing our own
import cats.implicits._
import org.scalatest.matchers.must.Matchers
import org.scalatest.wordspec.AnyWordSpec
import com.backwards.chap4.Option._

class Chap4OptionSpec extends AnyWordSpec with Matchers {
  "Option" should {
    "4.1 map" in {
